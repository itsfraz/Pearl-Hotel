...
import { FaBed, FaCalendarCheck, FaTags, FaChartLine, FaUsers, FaHome, FaUtensils, FaSpa, FaGlassCheers } from 'react-icons/fa';
...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    ...
    { path: '/admin/events', icon: <FaGlassCheers />, label: 'Events' },
